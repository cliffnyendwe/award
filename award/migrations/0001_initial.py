# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-12-21 05:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project', to='award.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rate', to='award.Project')),
        ...
        migrations.AddField(
            model_name='profile',
            name='rate',
            field=models.ManyToManyField(max_length=30, related_name='image', to='award.Project'),
        ),
    ]
